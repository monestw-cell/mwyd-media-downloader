...
class DownloadViewModel(private val application: Application) : AndroidViewModel(application) {
    ...
    fun createDownloadItemFromResult(result: ResultItem?, url: String = "", givenType: DownloadType) : DownloadItem {
        ...
        val videoEmbedThumb = sharedPreferences.getBoolean("video_embed_thumbnail", true)
        ...
        val subsLanguages = sharedPreferences.getString("subs_lang", "ar.*,en.*")!!
        ...
        return DownloadItem(0,
            ...
            "",
            if (resultItem.playlistTitle == resultRepository.MWYD_SEARCH) "" else resultItem.playlistTitle,
            audioPreferences,
            videoPreferences,
            extraCommands,
