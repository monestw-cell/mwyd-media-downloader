...
object ThemeUtil {
    ...
    sealed class AppIcon(
        ...
        object Terminal : AppIcon(R.string.terminal, R.mipmap.terminal_icon, "TerminalIcon")
    }
    ...
    fun updateTheme(activity: Activity) {
        ...
        //update accent
        when (sharedPreferences.getString("theme_accent","mwyd")) {
            "Default" -> {
            ...
            "mwyd" -> activity.setTheme(R.style.Theme_Mwyd)
        }
        ...
        val theme = sharedPreferences.getString("mwyd_theme", "Dark")!!
        when (theme) {
            "Light" -> {
        ...
        val iconMode = sharedPreferences.getString("mwyd_icon", "Default")!!
        updateAppIcon(activity,theme, iconMode)
    }

    fun getThemeColor(context: Context, colorCode: Int): Int {
        val sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context)
        val accent = sharedPreferences.getString("theme_accent", "mwyd")
    ...
    fun getStyledAppName(context: Context): Spanned {
        ...
        return "<span  style='color:$hexColor';>MWYD</span>"
